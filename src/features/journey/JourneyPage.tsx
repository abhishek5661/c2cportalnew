  ...
  return (
    <div className="min-h-full space-y-6 pb-16">
      ...
      <div className="rounded-3xl border border-slate-200 bg-[#FDFEFE] p-4 sm:p-6 lg:p-8 shadow-sm space-y-8">
        ...
        {/* 3-WING SPATIAL MINDMAP GRID */}
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-12 items-start">
          
          {/* ========================================================= */}
          {/* LEFT WING: 1. Core Skills (Top) & 5. Career Prep (Bottom) */}
          {/* ========================================================= */}
          <div className="lg:col-span-3 space-y-6">
            
            {/* 1. CORE SKILLS (MUST HAVE) - PURPLE THEME */}
            <div className="rounded-2xl border-2 border-purple-400/80 bg-purple-50/20 p-4 space-y-3.5 shadow-xs">
              ...
              {/* Sub-block 1: DSA & Problem Solving */}
              ...
              {/* Sub-block 4: Development Skills */}
              <div className="rounded-xl border border-purple-200 bg-white p-3 space-y-1.5">
                <h4 className="font-display text-[11px] font-black tracking-wide text-purple-900 uppercase">
                  Development Skills
                </h4>
              ...
              {/* Sub-block 5: Tools & Technologies */}
              <div className="rounded-xl border border-purple-200 bg-white p-3 space-y-1.5">
                <h4 className="font-display text-[11px] font-black tracking-wide text-purple-900 uppercase">
                  Tools &amp; Technologies
                </h4>
              ...
              {/* Sub-block 6: Frontier Technologies */}
              <div className="rounded-xl border border-purple-200 bg-white p-3 space-y-1.5">
                <h4 className="font-display text-[11px] font-black tracking-wide text-purple-900 uppercase">
            ...
            {/* 5. CAREER PREPARATION - BLUE THEME */}
                ...
                {[
                  {
                    ...
                    icon: FileText,
                    desc: 'Impactful, ATS Friendly, Projects, Skills, Achievements',
                  },
                  {
                    title: 'GITHUB & PORTFOLIO',
                    icon: Github,
                    desc: 'Clean, Organized, Well Documented',
                  },
                  {
                    title: 'LINKEDIN BRANDING',
                    icon: Linkedin,
                    desc: 'Headline, About, Experience, Projects, Posts',
                  },
                  {
                  ...
                  },
                  {
                    ...
                    icon: Users,
                    desc: 'Technical + HR + Managerial',
                  },
                  {
                    title: 'COMPANY PREPARATION',
                    icon: Building2,
                    desc: 'Onboarding Process, Culture, Tech Stack, Recent Updates',
                  },
                  {
                    title: 'PLACEMENT TRAINING',
                    icon: Award,
                    desc: 'Group Discussions, HR Rounds, Salary Negotiation',
                  },
                ].map((item, idx) => (
                  <div
                    key={idx}
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <h4 className="font-display text-[11px] font-black text-blue-950">
                        {item.title}
                      </h4>
          ...
          {/* ========================================================= */}
          {/* CENTER SPINE: 2. Personal Skills -> Central Hub ->        */}
          {/* 7. Roadmap Table -> 8. Weekly Ritual -> 9. End State      */}
          {/* ========================================================= */}
          <div className="lg:col-span-6 space-y-6">
            
            {/* 2. PERSONAL & PROFESSIONAL SKILLS - ORANGE THEME */}
            ...
            {/* 7. 4-YEAR JOURNEY ROADMAP (TABLE) */}
            ...
            {/* 8. WEEKLY STUDENT RITUAL (EXAMPLE) */}
                ...
                {[
                  ...
                  >
                    ...
                    <div className="pt-1.5">
                      <p className="font-display text-[10px] font-bold text-ink leading-tight">
                        {item.title}
                      </p>
                      <p className="text-[9px] text-ink-muted leading-tight mt-0.5">
                        {item.sub}
                      </p>
                    </div>
                  </div>
          ...
          {/* ========================================================= */}
          {/* RIGHT WING: 3. Experience Activities (Top) +              */}
          {/* 4. Continuous Feedback (Mid) + 6. Motivation System (Btm) */}
          {/* ========================================================= */}
          <div className="lg:col-span-3 space-y-6">
            
            {/* 3. EXPERIENCE BUILDING ACTIVITIES - GREEN THEME */}
                ...
                {[
                  {
                    title: 'PROJECTS',
                    icon: FolderGit2,
                    items: ['Mini Projects (Year 1)', 'Full Stack Projects (Year 2)', 'Advanced Projects (Year 3)', 'Industry Grade Project (Year 4)'],
                  },
                  {
                    title: 'HACKATHONS',
                    icon: Trophy,
                    items: ['Internal College Hackathons', 'National Hackathons', 'Track & Theme Based', 'Build, Ship & Present'],
                  },
                  {
                    title: 'CODING CONTESTS',
                    icon: Code2,
                    items: ['Weekly Practice Contests', 'Bi-weekly Timed Contests', 'Platform Contests (Codeforces, LeetCode, CodeChef, etc.)', 'College Coding League'],
                  },
                  {
                    title: 'OPEN SOURCE',
                    icon: GitBranch,
                    items: ['Explore', 'Contribute', 'Create', 'Maintain'],
                  },
                  {
                    title: 'INTERNSHIPS',
                    icon: Briefcase,
                    items: ['Summer Internships', 'Part-time / Remote', 'Industry Exposure', 'Real World Problems'],
                  },
                  {
                    title: 'COMPETITIONS',
                    icon: Medal,
                    items: ['Tech Events', 'Paper Presentations', 'Case Studies', 'Innovation Challenges'],
                  },
                  {
                    title: 'COMMUNITY & NETWORKING',
                    icon: Network,
                    items: ['Tech Communities', 'Meetups & Workshops', 'Mentorship', 'LinkedIn Networking'],
                  },
                  {
                    title: 'TECHNICAL PRESENTATIONS',
                    icon: Presentation,
                    items: ['Project Demos', 'PPT Sessions', 'Explain Concepts', 'Peer Teaching'],
                  },
                ].map((act, idx) => (
                  <div
                    key={idx}
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <h4 className="font-display text-[11px] font-black text-emerald-950">
                        {act.title}
                      </h4>
            ...
            {/* 4. CONTINUOUS ASSESSMENT & FEEDBACK LOOP - RED/ROSE THEME */}
              ...
              <div className="space-y-1.5 text-xs">
                {[
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <p className="font-display text-[10px] font-black text-rose-950 leading-none">
                        {loop.title}
                      </p>
            ...
            {/* 6. INTERVENTION & MOTIVATION SYSTEM - YELLOW/GOLD THEME */}
            <div className="rounded-2xl border-2 border-amber-400/80 bg-amber-50/20 p-4 space-y-3.5 shadow-xs">
              ...
              <div className="space-y-1.5 text-xs">
                {[
                  ...
                  >
                    <div className="min-w-0">
                      <p className="font-display text-[10px] font-black leading-tight uppercase">
                        {mot.title}
                      </p>
